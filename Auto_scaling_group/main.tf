...
#     for_each = each.value.traffic_sources # Use a list of traffic sources for each key

#     content {
#       identifier = traffic_source.value.identifier
#       type       = try(traffic_source.value.type, "elbv2")
#     }
#   }
# }
  ...
  dynamic "target_tracking_configuration" {
    ...
    content {
      ...
      dynamic "predefined_metric_specification" {
        ...
        content {
          predefined_metric_type = predefined_metric_specification.value.predefined_metric_type  # https://docs.aws.amazon.com/autoscaling/application/APIReference/API_PredefinedMetricSpecification.html
