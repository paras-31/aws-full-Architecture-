...
#   replica_mode                = var.replica_mode
#   auto_minor_version_upgrade  = var.auto_minor_version_upgrade
#   custom_iam_instance_profile = var.custom_iam_instance_profile # Instance profile is required for Custom for Oracle. See: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-setup-orcl.html#custom-setup-orcl.iam-vpc
